...
#include "stackADT.h" //include header file
...
{
    return(stackTop == nullptr); //sets stacktop to null
} //end isEmptyStack
...
(const linkedStackType<Type>& otherStack)
{
    ...
    else
    {
        ...
        {
            newNode = new nodeType<Type>; //creates new node
            
            newNode->info = current->info;
            newNode->link = nullptr; //sets new node to null
            last->link = newNode;
            last = newNode;
...
(const linkedStackType<Type>& otherStack)
{
    if (this != &otherStack) //avoid self-copy
        copyStack(otherStack); //calls function
